...
- [Installation](./installation.md)
  ...
  - [Updating RayCanary](./updating-raycanary.md)
- [Configuration](./configuration.md)
- [Uninstalling](./uninstalling.md)
- [Using RayCanary](./using-raycanary.md)
  - [RayCanary's heuristics](./heuristics.md)
  - [Audible alerts (speaker)](./speaker.md)
  - [Hardware build guide](./hardware-build.md)
