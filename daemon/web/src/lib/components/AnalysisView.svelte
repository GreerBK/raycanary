    ...
    {:else}
        ...
        <div class="flex flex-col gap-2">
            {#if !!numWarnings || !current}
                <div class="flex flex-row justify-between items-center">
                    {#if !!numWarnings}
                        ...
                        >
                            Your RayCanary device raised {`${numWarnings}`} warning{`${
                                numWarnings > 1 ? 's' : ''
                            }`}!
                            <a
                                href="https://greerbk.github.io/raycanary/faq.html#red"
            ...
            <div>
                ...
                {#if metadata !== undefined && metadata.raycanary !== undefined}
                    <p><b>RayCanary version:</b> {metadata.raycanary.raycanary_version}</p>
                    <p><b>Device system OS:</b> {metadata.raycanary.system_os}</p>
                {:else}
                    <p>N/A (analysis generated by an older version of raycanary)</p>
                {/if}
